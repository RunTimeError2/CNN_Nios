...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../First_Nios.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100011d0
SOPC_SYSID_FLAG += --sidp=0x100011d0
ELF_PATCH_FLAG  += --sidp 0x100011d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1531484321
SOPC_SYSID_FLAG += --timestamp=1531484321
ELF_PATCH_FLAG  += --timestamp 1531484321
